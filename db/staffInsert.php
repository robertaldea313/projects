...
<!-- Page Content -->
<div style="margin-left:26%; margin-top:170px" >

  <center class ="center">
    <b>
    <form METHOD = POST ACTION ="http://localhost/staffIPHP.php">
      <label for="sID">Staff ID:</label><br>
      <input type="number" id="sID" name="sID" placeholder="ID" required><br>

      <label for="mPay">Monthly Pay:</label><br>
      <input type="number" id="mPay" name="mPay" placeholder="Monthly Pay" required><br>

      <label for="sfName">First Name:</label><br>
      <input type="text" id="sfName" name="sfName" placeholder="First Name" required><br>

      <label for="slName">Last Name:</label><br>
      <input type="text" id="slName" name="slName" placeholder="Last Name" required><br>
